...
namespace Deposit_Tests
{
    public class CustomerDepositTest
    {
        ...
        public void MakeCustomerDeposit_ZeroAmount_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => CustomerDeposit.MakeCustomerDeposit(customerOrder.CustomerOrderItems.First(), 0, DepositMovement.Out));
        }
        ...
        public void MakeCustomerDeposit_NegativeAmount_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => CustomerDeposit.MakeCustomerDeposit(customerOrder.CustomerOrderItems.First(), -5, DepositMovement.Out));
        }
