...
namespace Deposit_Tests
{
    ...
    {        
        ...
        public void MakeProviderOrder_ZeroRegisterNumber_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => ProviderOrder.MakeProviderOrder(0, provider));
        }
        ...
        {
            // act
            Assert.Throws<ArgumentNullException>(() => ProviderOrder.MakeProviderOrder(5, null));
        }
        ...
        public void UpdateTotalValue_NegativeTotal_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => providerOrder.UpdateTotalValue(-50));
        }
        ...
        public void AddItem_ZeroAmount_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => providerOrder.AddItem(product, 0));
        }
