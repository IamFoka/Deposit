...
namespace Deposit_Tests
{
    public class CustomerTest
    {
        ...
        public void UpdateDocumentation_Customer_Deleted()
        {
            ...
            // act
            Assert.Throws<InvalidOperationException>(() => customer.UpdateDocumentation("Guilherme", "10681541016"));
        }
        ...
        public void UpdateToalSpent_Customer_Deleted()
        {
            ...
            // act
            Assert.Throws<InvalidOperationException>(() => customer.UpdateTotalSpent(50));
        }
        ...
        public void DeleteCustomer_DeletedCustomer_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<InvalidOperationException>(() => customer.Delete());
        }
    }
}