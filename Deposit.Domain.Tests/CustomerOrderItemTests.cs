...
namespace Deposit_Tests
{
    public class CustomerOrderItemTests
    {
        ...
        public void MakeItem_ZeroAmount_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => CustomerOrderItem.MakeCustomerOrderItem(customerOrder, product, 0));
        }
        ...
        public void ChangeAmount_SameAmountAsBefore_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => customerOrderItem.ChangeAmount(5));
        }
        ...
        public void ChangeAmount_ZeroAmount_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => customerOrderItem.ChangeAmount(0));
        }
        ...
        public void ChangeAmount_NegativeAmount_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => customerOrderItem.ChangeAmount(-10));
        }
        ...
        public void ChangePrice_SamePriceAsBefore_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => customerOrderItem.ChangePrice(15));
        }
        ...
        public void ChangePrice_ZeroPrice_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => customerOrderItem.ChangePrice(0));
        }
        ...
        public void ChanceAmount_ItemDeleted_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<InvalidOperationException>(() => customerOrderItem.ChangeAmount(-2));
        ...
        public void Change_Price_ItemDeleted_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<InvalidOperationException>(() => customerOrderItem.ChangePrice(20));
        }
