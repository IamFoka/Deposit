...
namespace Deposit_Tests
{
    public class CustomerOrderTests
    {
        ...
        public void MakeCustomerOrder_ZeroRegisterNumber_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => CustomerOrder.MakeCustomerOrder(0, customer));
        }
        ...
        public void MakeCustomerOrder_NegativeRegisterNumber_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => CustomerOrder.MakeCustomerOrder(-5, customer));
        }
        ...
        {
            // act
            Assert.Throws<ArgumentNullException>(() => CustomerOrder.MakeCustomerOrder(5, null));
        }
        ...
        public void UpdateTotalValue_ZeroValue_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => customerOrder.UpdateTotalValue(0));
        }
        ...
        public void UpdateTotalValue_NegativeTotal_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => customerOrder.UpdateTotalValue(-50));
        }
        ...
        public void AddItem_NullProduct_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentNullException>(() => customerOrder.AddItem(null, 5));
        }
        ...
        public void AddItem_ZeroAmount_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => customerOrder.AddItem(product, 0));
        }
        ...
        public void AddItem_NegativeAmount_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => customerOrder.AddItem(product, -5));
        }
        ...
        public void AddItem_AmountBiggerThanProducts_ExceptionThrown()
        {
            ...
            // act
            Assert.Throws<ArgumentException>(() => customerOrder.AddItem(product, 15));
        }
        ...
        public void AddItem_CustomerOrder_Deleted()
        {
            ...
            // act
            Assert.Throws<InvalidOperationException>(() => customerOrder.Delete());
        }
        ...
        public void UpdateTotalValue_CustomerOrder_Deleted()
        {
            ...
            // act
            Assert.Throws<InvalidOperationException>(() => customerOrder.UpdateTotalValue(1));
        }
